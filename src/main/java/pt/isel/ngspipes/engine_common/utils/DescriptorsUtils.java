...
public class DescriptorsUtils {
    ...
    public static IToolDescriptor getTool(IToolsRepository repo, String toolName, String stepId) throws EngineCommonException {
        try {
    ...
    public static ICommandDescriptor getCommand(IToolsRepository toolsRepository, ICommandExecDescriptor commandExecDescriptor) throws EngineCommonException {
        ...
        try {
            ...
            throw new EngineCommonException("Not tool found with name: " + toolName, e);
        }

        throw new EngineCommonException("Not command: " + commandName + " was found for tool: " + toolName);
    }
    ...
    public static IOutputDescriptor getOutputFromCommand(ICommandDescriptor commandDescriptor, String outputName) {
    ...
    public static IPipelineDescriptor getPipelineDescriptor(IPipelinesRepository repo, String pipelineName) throws EngineCommonException {
        try {
            return repo.get(pipelineName);
        } catch (PipelinesRepositoryException e) {
            throw new EngineCommonException("Error getting pipeline " + pipelineName + " descriptor", e);
        }
    }
    ...
    public static Object getInputValue(IInputDescriptor input, Map<String, Object> parameters) throws EngineCommonException {
        ...
        throw new EngineCommonException("No implementation exist to get the input: " + input.getInputName() + " value");
    }
    ...
    public static ICommandDescriptor getCommandDescriptor(IStepDescriptor step, IPipelineDescriptor pipelineDesc, Map<String, Object> parameters) throws EngineCommonException {
