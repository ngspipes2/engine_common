...
public class SpreadJobExpander {
    ...
    private static void updateJoinJobChainInputValues(Job job) throws EngineCommonException {
        // update in values
        ...
        for (Input in : spreadChainInputs) {
            ...
            if (type.equalsIgnoreCase("directory")) {
                ...
                throw new EngineCommonException("Input " + in.getName() + " value for incoming spread result and type "
                        + type + "not supported.");
            }
        }
    }
